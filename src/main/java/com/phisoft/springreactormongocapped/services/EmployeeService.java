package com.phisoft.springreactormongocapped.services;


import com.phisoft.springreactormongocapped.dto.EmployeeDto;
import com.phisoft.springreactormongocapped.repositories.EmployeeRepository;
import com.phisoft.springreactormongocapped.utils.AppUtils;
...
public class EmployeeService {
    ...
    public Flux<EmployeeDto> streamEmployees(){
     return  employeeRepository.findWithTailableCursorBy().map(AppUtils::toDto);
    }
